package io.syndesis.qe.pages.integrations.detail.monitoring;
...
@Slf4j
public class IntegrationActivityListComponent extends SyndesisPageObject {
    @Autowired
...
//AUXILIARIES:
    ...
    private boolean checkActivityText(Activity activity, String activityStepName, String expectedText) {
        ...
        if (buildPod.isPresent()) {
            ...
            //2. TODO(sveres)  question: there is table of activity steps (ACTIVITY_STEPS) how is this mapped to Activities list of integration?
