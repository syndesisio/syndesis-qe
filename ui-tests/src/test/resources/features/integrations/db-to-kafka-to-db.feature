...
#    A.db to kafka:
    When created Kafka connection using AMQ streams auto detection using "<type>" security
      | Kafka Message Broker | Kafka Autodetect <type> | Kafka Auto Detect QE <type> | Kafka Streams Auto Detection |
