...
Feature: Connections CRUD test
  ...
  Scenario: CREATE and DELETE salesforce connection happy path
    ...
    And type "my sample salesforce connection" into connection name
    And type "this connection is awesome" into connection description
    And click on the "Create" button
    Then Camilla is presented with the Syndesis page "Connections"

    When Camilla selects the "my sample salesforce connection" connection
    Then Camilla is presented with "my sample salesforce connection" connection details

    When "Camilla" navigates to the "Connections" page
    Then Camilla is presented with the Syndesis page "Connections"

    When Camilla deletes the "my sample salesforce connection" connection
    # delete was not fast enough some times so sleep is necessary
    Then she stays there for "2000" ms
    Then Camilla can not see "my sample salesforce connection" connection anymore