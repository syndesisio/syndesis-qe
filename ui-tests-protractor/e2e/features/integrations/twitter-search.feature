...
https://app.zenhub.com/workspace/o/syndesisio/syndesis-project/issues/3
  ...
  Scenario: Create Salesforce and Twitter connections
  ...
  Scenario: Create integration with twitter and search settings
    ...
    And clicks on the "Create Integration" button
    ...
    And she defines integration name "Twitter search integration E2E"
    And clicks on the "Save as Draft" button
    Then Camilla is presented with "Twitter search integration E2E" integration details
    And Camilla clicks on the "Done" button
