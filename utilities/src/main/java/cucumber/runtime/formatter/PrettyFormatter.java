...
/**
 * Shadowed pretty formatter class. Since version 4 cucumber supports parallel execution and PrettyFormatter needs to implements ConcurrentEventListener.
...
final class PrettyFormatter implements ConcurrentEventListener, ColorAware {
    ...
    private void printStep(PickleStepTestStep testStep, Result result) {
        ...
        String formattedStepText = formatStepText(keyword, stepText, formats.get(format), formats.get(format + "_arg"), testStep.getDefinitionArgument());
