...
public class IntegrationFlowView extends SyndesisPageObject {
    ...
    public void addDatamapperStep(String action) {
        ...
        Selenide.$(ByUtils.dataTestId("button", buttonDataTestid)).shouldBe(visible).click();
        Selenide.$(ByUtils.dataTestId("a", "integration-editor-step-adder-add-step-before-connection-link")).shouldBe(visible).click();
    }
